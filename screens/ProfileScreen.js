...
export default class ProfileScreen extends React.Component {
  ...
  componentDidMount = async () => {
    ...
    console.log(token)
    if (token !== null) {
      fetch(`http://192.168.0.103:8082/stores/users/profile`, {
        method: 'GET',
        headers: {
  ...
  verifyToken() {
    ...
    fetch(`http://192.168.0.103:8082/stores/users/${this.state.auth.user._id}/verify`, {
      method: 'POST',
      headers: {
        'Accept': 'application/json',
        'Content-Type': 'application/json'
  ...
  signUp() {
    this.setState({ showProgress: true })
    fetch('http://192.168.0.103:8082/stores/users', {
      method: 'POST',
      headers: {
        'Accept': 'application/json',
        'Content-Type': 'application/json'
  ...
  login() {
    ...
    if (!this.state.isExists) {
      fetch(`http://192.168.0.103:8082/stores/users/${this.state.number}/userExists`, {
        method: 'POST',
        headers: {
          'Accept': 'application/json',
          'Content-Type': 'application/json'
      ...
      fetch(`http://192.168.0.103:8082/stores/users/login`, {
        method: 'POST',
        headers: {
          'Accept': 'application/json',
          'Content-Type': 'application/json'
